...
public class ProjectSpecificMethod {
	...
	@Parameters({"lang"})
	@BeforeSuite
	public void loadObjects(String lang) throws FileNotFoundException, IOException {
		property = new Properties();
		property.load(new FileInputStream("./objectRepo/"+lang+".properties"));
	}
	...
	public void openApp(String url) {
		...
		driver = new ChromeDriver(); //driver = 1
